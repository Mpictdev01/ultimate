      ...
      <div className="admin-card">
        ...
        <form onSubmit={handleSubmit} className="admin-form">
          <div className="admin-form__group">
            ...
            <input name="title" required className="admin-form__input" placeholder="Article Title" />
          </div>

          <div className="admin-form__group">
            <label className="admin-form__label">Slug (Optional - Auto Generated if empty)</label>
            <input name="slug" className="admin-form__input" placeholder="article-title-slug" />
          </div>

          <ImageUpload name="image_url" label="Article Image" />

           <div className="admin-form__group">
            <label className="admin-form__label">Excerpt</label>
            <textarea name="excerpt" className="admin-form__textarea" style={{minHeight: '80px'}} placeholder="Short summary..." />
          </div>

          <div className="admin-form__group">
            <label className="admin-form__label">Content (HTML/Markdown)</label>
            <textarea name="content" className="admin-form__textarea" style={{minHeight: '300px'}} placeholder="Article content..." />
          </div>

           <div className="admin-form__group">
            <label className="admin-form__label">Published Date</label>
            <input name="published_date" type="datetime-local" className="admin-form__input" />
          </div>
