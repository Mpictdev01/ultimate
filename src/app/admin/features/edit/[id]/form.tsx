...
export default function EditFeatureForm({ item }: { item: any }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await updateFeature(item.id, data);
      ...
      <div className="admin-card">
        ...
        <form onSubmit={handleSubmit} className="admin-form">
          ...
          <div className="admin-form__group">
            ...
            <input name="title" required defaultValue={item.title} className="admin-form__input" placeholder="Feature Title" />
          </div>
          ...
          <div className="admin-form__group">
            ...
            <textarea name="description" defaultValue={item.description} className="admin-form__textarea" placeholder="Feature Description" />
          </div>
