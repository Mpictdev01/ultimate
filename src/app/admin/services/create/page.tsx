      ...
      <div className="admin-card">
        ...
        <form onSubmit={handleSubmit} className="admin-form">
          <div className="admin-form__group">
            ...
            <input name="title" required className="admin-form__input" placeholder="Service Title" />
          </div>
          ...
          <div className="admin-form__group">
            ...
            <textarea name="description" className="admin-form__textarea" placeholder="Service Description" />
          </div>
